...
public class GGTmitFunktion {

	public static void main(String[] args) {

		Scanner sc = new Scanner(System.in);

		System.out.print("Bitte natuerliche Zahl A eingeben: "); // 1978
		int natuerlichezahlA = sc.nextInt();
		System.out.print("Bitte natuerliche Zahl B eingeben: "); // 2021
		...
		do {
			rest = restBeiDivision(natuerlichezahlA, natuerlichezahlB);
	...
	// Methode mit Modulo Rechnung
	private static int restBeiDivision(int natuerlichezahlA, int natuerlichezahlB) {
		int rest = natuerlichezahlA % natuerlichezahlB;
		return rest;
	}
